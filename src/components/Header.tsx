  ...
  const knowledgeBaseItems = [
    {
      ...
      path: '/knowledge-base/ecommerce'
    },
    {
      name: 'Restaurant Management Software',
      path: '/knowledge-base/restaurant'
    }
  ];
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex justify-between items-center">
          ...
          <Link
            ...
            aria-label="PikFusion - Web Development, SEO and Digital Solutions"
          >
            <motion.div
              whileHover={{
                scale: 1.1,
            ...
            >
              <img
                src={logo}
                alt="PikFusion Web Development and SEO Agency"
          ...
          >
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.path}
                className={`relative py-2 transition-colors duration-300 hover:text-purple-400 ${location.pathname === item.path
                    ? 'text-purple-400'
                    : 'text-white'
                  }`}
              >
              ...
              <AnimatePresence>
                {isKnowledgeBaseOpen && (
                  ...
                  <motion.div
                    ...
                    className="absolute top-full left-0 mt-2 w-72 bg-gray-900/95 backdrop-blur-lg rounded-xl border border-purple-500/20 shadow-xl overflow-hidden"
                  >

                    {knowledgeBaseItems.map(
                      (item, index) => (
              ...
              {navItems.map(
                (item, index) => (
                  ...
                  >
                    ...
                    <Link
                      to={item.path}
                      className={`block py-3 px-4 hover:text-purple-400 hover:bg-purple-500/10 transition-colors duration-300 border-b border-gray-700/50 ${location.pathname ===
                          item.path
                          ? 'text-purple-400'
                          : 'text-white'
                        }`}
              ...
              <div className="p-4">
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="w-full px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-white font-semibold"
                  >
                    Discuss Your Project
                  </motion.button>
