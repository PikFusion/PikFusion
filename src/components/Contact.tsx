  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formDataToSend.append(
        'access_key',
        'bf201f68-3f1d-4448-9b59-870b19fb0944'
      );
      ...
      setSubmitError(
        'Failed to send your message. Please try again or contact us directly by email.'
      );
    } finally {
  ...
  const contactInfo = [
    {
      ...
      details: [
        'admin@pikfusion.com',
        'pikfusion.digital.labs@gmail.com'
      ],
...

    {
      ...
      title: 'Visit PikFusion',
      details: [
        'PIKFUSION PRIVATE LIMITED, Sy No 135/1, No 4 & 5, 4th Floor, Maruthi Industrial Estate, Rajapalya, Hoody, Bangalore, Karnataka – 560048.'
      ],
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            SEO agency, custom software development partner,
            or digital solutions team? Talk to PikFusion about
            your website, web application, CRM, SaaS platform,
            eCommerce store, SEO strategy, UI/UX design, or
          ...
          >
            ...
            <div className="mb-8">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">
                Talk to Our Digital Solutions Team
              </h3>

              <p className="text-gray-300 text-lg leading-relaxed">
                Tell us about your business goals and technical
                requirements. Our team can help you plan and
                develop scalable web development, software,
                SEO, CRM, SaaS, eCommerce, and digital
            ...
            {isSubmitted ? (
              ...
              >
                ...
                <h3 className="text-3xl font-bold text-white mb-4">
                  Thank You for Contacting PikFusion
                </h3>
              ...
              >
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Share your website, application, SEO,
                    software, CRM, SaaS, eCommerce, or
                    automation requirements and our team
                    will discuss the right solution for
                    your business.
                  </p>
                ...
                <div>
                  ...
                  <label className="block text-sm font-medium text-gray-300 mb-2">
                    Service or Project Requirement *
                  </label>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-gray-800/50 border border-purple-500/30 rounded-xl text-white placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300"
                    placeholder="Web development, SEO, CRM, SaaS, eCommerce..."
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Tell us about your business goals, project requirements, preferred features, timeline, and any existing website or software..."
                  />
                ...
                <motion.button
                  ...
                  className={`w-full py-4 rounded-xl font-semibold text-white transition-all duration-300 flex items-center justify-center space-x-3 ${isSubmitting
        ...
        >
          ...
          >
            ...
            <p className="text-gray-300">
              Helping businesses build websites,
          ...
          >
            ...
            <p className="text-gray-300">
              Web development, CRM, SaaS,
              eCommerce, UI/UX, SEO, digital
          ...
          >
            ...
            <p className="text-gray-300">
              ...
              technology and digital strategy for
              your project.
            </p>
