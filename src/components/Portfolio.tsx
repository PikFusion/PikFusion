          ...
          >
            {filteredProjects.map((project, index) => (
              <motion.div
                ...
                className={`group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-lg rounded-3xl overflow-hidden border transition-all duration-500 ${
                  project.featured 
